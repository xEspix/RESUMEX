...
class ATSScore():
    ...
    def generateATSscore(self):
        ...
        if(self.resume_data.phone_no!="none"):
            if(rs.is_valid_phone_number_with_cc(self.resume_data.phone_no) and rs.is_valid_phone_number(self.resume_data.phone_no)):
                personal_details_score+=2
                
            elif(rs.is_valid_phone_number_with_cc(self.resume_data.phone_no) or rs.is_valid_phone_number(self.resume_data.phone_no)):
                personal_details_score+=1
        ...
        if(self.resume_data.email!="none"):
        ...
        if(self.resume_data.location!="none"):
            personal_details_score+=2
        else:
        ...
        if(self.resume_data.linkedin!="none"):
        ...
        if(self.resume_data.github!="none"):
        ...
        #SKILLS AND COMPETENCIES : TOTAL POINTS = 17

        skill_scores=0

        if(self.resume_data.skills!="none"):
        ...
        if(self.resume_data.courses!="none"):
            skill_scores+=2
        else:
        ...
        if(self.resume_data.companies!="none"):
        ...
        if(self.resume_data.achievements!="none"):
            count_achv=0
        ...
        score_edu=0
        map_edu=[1,1,1,1]
        if(self.resume_data.degree!="none"):
            score_edu+=5
        else:
            map_edu[0]=0
        
        if(self.resume_data.cllg_name!="none"):
            score_edu+=5
        else:
            map_edu[1]=0

        if(self.resume_data.grad_year!="none"):
            score_edu+=1
        else:
            map_edu[2]=0
        ...
        score_proj=0
        proj_num=0
        if self.resume_data.projects!="none":
        ...
        score_award=0
        if(self.resume_data.awards!="none"):
            award_num=0
        ...
        print("TOTAL SCORES = 75")

        perc=(score_obt/75)*100
        fresh_perc=((score_obt-exp_scores)/57)*100
